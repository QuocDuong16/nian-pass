...
- [Nian Pass — Architecture](overview.md) - Workspace structure, crate dependency direction, domain model, architecture invariants, security boundaries, KDBX adapter design, three-way sync engine, and verified persistence for Nian Pass.
