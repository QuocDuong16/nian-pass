...
export function runChecks(root) {
  ...
  requirePattern(violations, "docs/threat-model.md", threatModel, /malicious or compromised provider[\s\S]{0,900}conditional headers[\s\S]{0,1200}credential-chain surprise[\s\S]{0,1800}cryptographic remote[\s\S]{0,120}rollback/i, "M7 cloud threat and residual rollback model is missing");
