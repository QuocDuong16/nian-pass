...
export function runChecks(root) {
  ...
  requirePattern(violations, "docs/architecture.md", architecture, /activityResumed[\s\S]{0,100}windowFocused[\s\S]{0,100}processForeground[\s\S]{0,700}ProcessLifecycleOwner[\s\S]{0,300}not the immediate/i, "M5.5 Activity authority and delayed process-lifecycle boundary are missing");
