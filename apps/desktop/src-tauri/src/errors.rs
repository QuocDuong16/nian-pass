...
impl From<DesktopError> for DesktopErrorDto {
    fn from(value: DesktopError) -> Self {
        let code = match value {
            ...
            DesktopError::VaultCreateFailed => DesktopErrorCode::VaultCreateFailed,
            DesktopError::VaultAlreadyExists => DesktopErrorCode::VaultAlreadyExists,
            ...
            DesktopError::HistoryChanged => DesktopErrorCode::HistoryChanged,
            DesktopError::HistoryRestoreUnsupported => DesktopErrorCode::HistoryRestoreUnsupported,
            DesktopError::AttachmentNotFound => DesktopErrorCode::AttachmentNotFound,
            DesktopError::AttachmentAlreadyExists => DesktopErrorCode::AttachmentAlreadyExists,
            DesktopError::AttachmentTooLarge => DesktopErrorCode::AttachmentTooLarge,
            DesktopError::AttachmentIoFailed => DesktopErrorCode::AttachmentIoFailed,
            ...
            DesktopError::UnsupportedWriteFormat => DesktopErrorCode::UnsupportedWriteFormat,
            DesktopError::UnsupportedPersistencePlatform => {
                DesktopErrorCode::UnsupportedPersistencePlatform
            }
            DesktopError::ReadOnlySource => DesktopErrorCode::ReadOnlySource,
