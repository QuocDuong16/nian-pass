...
#[cfg(desktop)]
use commands::{
    change_master_password, clear_keyfile, close_policy, copy_entry_custom_field, copy_entry_notes,
    copy_entry_password, copy_entry_title, copy_entry_totp_code, copy_entry_url,
    copy_entry_username, copy_generated_password, create_entry, create_group, create_vault,
    credential_has_keyfile, credential_has_password, database_metadata, delete_entry,
    delete_entry_custom_field, delete_group, delete_sync_profile, discard_changes_and_lock,
    duplicate_entry, entry_attachments, entry_detail, entry_history, export_entry_attachment,
    export_vault_copy, history_policy, import_entry_attachment, import_entry_custom_icon,
    lock_vault, move_entries, move_entry, move_group, open_entry_url, password_health_report,
    permanently_delete_entries, permanently_delete_entry, permanently_delete_group, reload_vault,
    remove_keyfile, remove_master_password, rename_group, replace_keyfile, reset_sync_state,
    ...
    select_vault, set_entry_custom_field, set_entry_tags, set_history_max_items,
    set_recycle_bin_enabled, sync_now, sync_profiles, test_sync_provider, trash_entries,
    unlock_vault, unlock_vault_with_keyfile, update_database_metadata, update_entry,
    vault_snapshot,
};
#[cfg(desktop)]
use state::AppState;
...
pub fn run() {
    let app = with_desktop_plugins(tauri::Builder::default())
        .invoke_handler(tauri::generate_handler![
            ...
            copy_entry_url,
            copy_entry_notes,
            copy_entry_custom_field,
            copy_entry_password,
            copy_generated_password,
            copy_entry_totp_code,
            update_entry,
            create_entry,
            duplicate_entry,
            delete_entry,
...
fn run_mobile() {
    use mobile::attachment_commands::{
        mobile_export_entry_attachment, mobile_import_entry_attachment,
    };
    ...
    use mobile::commands::{
        ...
        mobile_set_entry_tags, mobile_unlock_vault, mobile_update_entry, runtime_info,
    };
    use mobile::read_commands::{
        mobile_entry_attachments, mobile_entry_detail, mobile_entry_history,
        mobile_entry_totp_code, mobile_load_entry_custom_field, mobile_load_entry_notes,
...
fn run_mobile() {
    ...
    use mobile::ios_commands::{
        ...
        mobile_enable_autofill_for_vault, mobile_entry_attachments, mobile_entry_detail,
        mobile_entry_history, mobile_entry_totp_code, mobile_lock_vault,
