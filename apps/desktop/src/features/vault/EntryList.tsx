...
export function EntryList({ group, entries, selectedEntryId, onSelect }: EntryListProps) {
  return (
            ...
            <li key={entry.id}>
              ...
              >
                <strong className="entry-title">
                  <Summary value={entry.title} missingLabel="Untitled entry" emptyLabel="Empty title" />
                </strong>
                <span className="entry-meta">
                  <Summary value={entry.username} missingLabel="No username" emptyLabel="Empty username" />
                </span>
                <span className="entry-meta entry-url">
                  <Summary value={entry.url} missingLabel="No URL" emptyLabel="Empty URL" />
                </span>
